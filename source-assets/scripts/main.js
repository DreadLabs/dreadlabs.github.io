...
(function() {
    ...
    navigator.serviceWorker.register('/service-worker.js', {scope: '/'})
        .then(function(registration) {
          ...
          registration.onupdatefound = function() {
            ...
            // installed, and there's no need to prompt for a reload at that
            // point.
            // So check here to see if the page is already controlled,
            // i.e. whether there's an existing service worker.
            if (navigator.serviceWorker.controller) {
              // The updatefound event implies that registration.installing
              // is set:
  ...
  const linksSelector = '.mdl-layout__drawer .mdl-navigation__link';
  ...
  const tagToggle = document
      .querySelector('ul[for="resume-tags-toggle__button"] li');
